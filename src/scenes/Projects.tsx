      ...
      <section id="projects" className="flex justify-center">
        <motion.div className="sm:grid sm:grid-cols-3" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={container}>
          ...
          {[
            ...
            { title: "ionic + Capacitor demo", image: "ionic-capacitor.png", repo: "https://github.com/arepaFlipper/ionic_capacitor", href: "http://telesign-chatapp.cristiantovar.com/", desc: "This is a project demostration for Assignar" },
