      ...
      <section id="projects" className="flex justify-center">
        <motion.div className="sm:grid sm:grid-cols-3" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={container}>
          ...
          {[
            ...
            { title: "fighting_game", image: "fighting_game.png", repo: "https://github.com/arepaflipper/fighting_game", href: "https://fighting-game-jet.vercel.app/", desc: "Just dove into this web-based fighting game built in vanilla TypeScript and I'm blown away! 👊💥 The fluidity of the animations and responsiveness of controls are top-notch. The devs nailed the balance between simplicity and depth, making it easy to pick up yet challenging to master. Love the diverse character roster and the strategic nuances each one brings. Kudos for the clean codebase in TypeScript – it's a joy for both players and devs. A true gem for browser gaming! #TypeScriptGaming #IndieGameDev #WebGames" },
